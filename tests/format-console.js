			...
			tests: [
				{
					...
					tests: [
						...
						{ name: "Semantic token",         arg: "<c pass>x</c>",              expect: "\\x1b[38;2;126;231;135mx\\x1b[0m" },
						{ name: "Hex literal",            arg: "<c #ff0000>x</c>",           expect: "\\x1b[38;2;255;0;0mx\\x1b[0m" },
						{ name: "Background",             arg: "<bg pass>x</bg>",            expect: "\\x1b[48;2;126;231;135mx\\x1b[0m" },
						{ name: "Nested preserves outer", arg: "<c pass><c fail>x</c>y</c>",
						  expect: "\\x1b[38;2;126;231;135m\\x1b[38;2;243;139;168mx\\x1b[0m\\x1b[38;2;126;231;135my\\x1b[0m" },
				...
				},
				{
					...
					data: { mode: "256" },
					tests: [
						{ name: "Semantic token (pass → #7ee787 → index 114)", arg: "<c pass>x</c>",    expect: "\\x1b[38;5;114mx\\x1b[0m" },
				...
				},
				{
					...
					tests: [
						{ name: "Single foreground", arg: "<c pass>x</c>",
						  expect: ["%cx%c", "color:#7ee787", ""] },
						{ name: "Nested foreground", arg: "<c pass><c fail>x</c></c>",
						  expect: ["%c%cx%c%c", "color:#7ee787", "color:#f38ba8", "color:#7ee787", ""] },
						{ name: "Background plus bold", arg: "<b><bg pass>x</bg></b>",
						  expect: ["%c%cx%c%c", "font-weight:bold", "font-weight:bold;background:#7ee787", "font-weight:bold", ""] },
						{ name: "Diff-style", arg: "<bg gutter> <c diff-added>+ added</c> <c diff-removed>- removed</c></bg>",
